...
* **pp-redis-queue** — Railway-deployed Redis instance used exclusively by BullMQ for job queues. Connection: `REDIS_URL` (.env). See `src/interfaces/redis/queues.prompt.md`.
