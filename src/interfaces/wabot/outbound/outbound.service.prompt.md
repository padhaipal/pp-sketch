...
Request shape: see src/interfaces/wabot/outbound/outbound.dto.prompt.md DownloadMediaRequest.
...
WABOT_INTERNAL_BASE_URL is available in .env.
Request shape: see src/interfaces/wabot/outbound/outbound.dto.prompt.md UploadMediaRequest.
* POST to ${WABOT_INTERNAL_BASE_URL}/uploadMedia with:
  ...
  - Query string: otel_carrier serialized as JSON in the `otel` query param (?otel=...).
