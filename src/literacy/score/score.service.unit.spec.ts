// Unit-only counterpart to score.service.spec.ts (which is integration
// and gated on TEST_DATABASE_URL). These run unconditionally and cover
// the pure-logic paths by mocking DataSource.query.
